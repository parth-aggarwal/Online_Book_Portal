...
public class PrintRequestsAdmin extends GenericServlet{
	...
	{   //String uname = req.getParameter("username");
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("Select * from " + IRequestConstants.TABLE_REQUEST + " where " + IRequestConstants.COLUMN_NAME + " IS NOT NULL ");        
			ResultSet rs = ps.executeQuery();
			RequestDispatcher rd = req.getRequestDispatcher("ViewBooks3.html");
			rd.include(req, res);
			pw.println("<div class=\"tab hd brown \">Books Requests</div>");
     		pw.println("<div class=\"tab\"><form action=\"buys\" method=\"post\">");
			pw.println("<table>\r\n" + 
					"			<tr>\r\n" + 
					"				<th>Owner Name of the Book</th>\r\n" + 
					"				<th>User Name of the Requester</th>\r\n" + 
					"				<th>Request ID</th>\r\n" + 
					"				<th>Code</th>\r\n" + 
					"				<th>Name</th>\r\n" + 
					"				<th>Author</th>\r\n" +
