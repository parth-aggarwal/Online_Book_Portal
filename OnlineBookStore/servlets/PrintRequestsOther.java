...
public class PrintRequestsOther extends GenericServlet{
	...
	{   String uname = req.getParameter("username");
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("Select * from " + IRequestConstants.TABLE_REQUEST + " where " + IRequestConstants.COLUMN_NAME + " IS NOT NULL and ownerid=\'"+uname+"\'");        
