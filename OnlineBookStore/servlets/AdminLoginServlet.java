	...
	public void service(ServletRequest req, ServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (rs.next()) {
				...
				rd.include(req, res);
				pw.println("<div class=\"tab hd brown\">Admin login Successful</div>");
				pw.println("<div class=\"tab\"><br/><a href=\"adminreq\">Generate requests report</a><br/></div>");
				pw.println("<div class=\"tab\"><br/><a href=\"RemoveBooks.html\">Remove Any Book</a><br/></div>");
				pw.println("<div class=\"tab\"><br/><a href=\"adminview\">View Book ~Advanced</a></div>");
				pw.println("<div class=\"tab\"><br/><a href=\"allusers\">View All Users</a></div>");
				pw.println("<div class=\"tab\"><br/><a href=\"DeleteUser.html\">Delete Any User</a></div>");
			} else {
